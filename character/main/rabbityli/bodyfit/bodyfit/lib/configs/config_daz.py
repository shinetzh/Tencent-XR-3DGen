...
cfg.init = CN()
cfg.init.bone_index = [47,    50,   2,    5]
cfg.init.bone_angle = [-0.8, 0.8, 0.1, -0.1]
...
cfg.scale_trn.w_chamfer =1000
cfg.scale_trn.w_ldmk = 0
cfg.scale_trn.w_shape_reg = 0
cfg.scale_trn.step = 200
...
cfg.pose_trn_betas.w_chamfer =1000
cfg.pose_trn_betas.w_ldmk = 0
cfg.pose_trn_betas.w_shape_reg = 1e-6
cfg.pose_trn_betas.n_sample = 1650
cfg.pose_trn_betas.step = 500
