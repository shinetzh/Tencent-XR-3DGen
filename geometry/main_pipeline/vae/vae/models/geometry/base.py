...
from vae.utils.ops import chunk_batch, scale_tensor
...
class BaseImplicitGeometry(BaseGeometry):
    ...
    def isosurface(self) -> Mesh:
        ...
        if self.cfg.isosurface_coarse_to_fine:
            vae.debug("First run isosurface to get a tight bounding box ...")
            with torch.no_grad():
            ...
            vae.debug("Run isosurface again with the tight bounding box ...")
