...
from vae.utils.misc import get_world_size
from vae.utils.ops import generate_dense_grid_points

from vae.models.autoencoders.customized_marching_cubes import sparse_marching_cubes, dense_marching_cubes
...
class AutoEncoder(BaseModule):
    ...
    def extract_geometry(self,
        ...
        if method == 'sparse':
            ...
            vertices, faces = sparse_marching_cubes(self.sparse_query, latents, init_depth, final_depth, 0.0, surface_in, surface_out, surface_range_decay, bounds=(-1,1), verbose=True)
