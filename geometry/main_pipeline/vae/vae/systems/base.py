...
import vae
from vae.utils.base import (
    Updateable,
    update_end_if_possible,
    update_if_possible,
)
from vae.utils.scheduler import parse_optimizer, parse_scheduler
from vae.utils.config import parse_structured
from vae.utils.misc import C, cleanup, get_device, load_module_weights
from vae.utils.saving import SaverMixin
...
class BaseSystem(pl.LightningModule, Updateable, SaverMixin):
    ...
    def on_before_optimizer_step(self, optimizer, batch_idx=0):
        """
