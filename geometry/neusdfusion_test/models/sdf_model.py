...
class SdfModel(pl.LightningModule):
    ...
    def __init__(self, specs):
        ...
        self.triplane_dim = model_specs["triplane_dim"]
        ...
        self.pn_hidden = model_specs.get("pn_hidden_dim", self.triplane_dim)
        self.pointnet = ConvPointnet(c_dim=self.triplane_dim, hidden_dim=self.pn_hidden, plane_resolution=self.plane_resolution)
        
        self.model = SdfDecoder(latent_size=self.triplane_dim, hidden_dim=self.hidden_dim, skip_connection=self.skip_connection, tanh_act=self.tanh_act)
