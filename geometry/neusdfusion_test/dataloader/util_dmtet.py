...
# obj_cfg_path = "/apdcephfs_data_cq2_1/share_1615605/3dAsset_common/3DCharacter/vroid/0/382192830845740/382192830845740_output_transparent/cam_parameters.json"
# with open(obj_cfg_path, 'r') as fr:
#     obj_cfg = json.load(fr)
# fovy = focal_length_to_fovy(obj_cfg['cam-0001']['k'][0][0], 512)
# proj = perspective(fovy, 1.0, 0.01, 100)
...
def rotate_scene(itr_all=30, batch_size=8, cam_radius=2.):
    ...
    for itr in range(itr_all):
        ...
        mv = translate(0, 0, -cam_radius) @ (rotate_x(-0.4) @ rotate_y(ang))
        mvp    = proj @ mv
