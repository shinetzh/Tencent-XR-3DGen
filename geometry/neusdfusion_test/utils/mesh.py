...
def extract_surface_points(obj_file_path, num_points):
    # Load the OBJ file
...
def load_and_downsample_ply(file_path, num_points):
    # Load the PLY file as a mesh
    point_cloud = o3d.io.read_triangle_mesh(file_path)
    # Convert the mesh to a point cloud
    point_cloud = point_cloud.sample_points_uniformly(num_points)
