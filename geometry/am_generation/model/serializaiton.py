import trimesh
import numpy as np
from model.data_utils import discretize, undiscretize
...
def BPT_serialize(mesh: trimesh.Trimesh, block_size=8, offset_size=16, compressed=True, special_token=-2, use_special_block=True):
    ...
    codes = get_block_representation(
        sequence, block_size=block_size, offset_size=offset_size, 
        block_compressed=compressed, special_token=special_token, use_special_block=use_special_block
    )
    return codes    
...
if __name__ == '__main__':
    ...
    import torch
    mesh = load_process_mesh('/aigc_cfs_10/Asset/objaverse/meshes/new_art/conflatio/standard_part1/mesh/pod_0/objaverse/1e1b0163430b4d788151de1dbc45ec94/texture/texture.obj', quantization_bits=7)
