...
accelerate launch --num_processes 1 --main_process_port 36828 \
    examples/modality_transfer/train_img2img_albedo.py \
    --output_dir="/aigc_cfs_4/xibin/code/diffusers_triplane_models/img2img_albedo_6views_100k" \
    --pretrained_model_name_or_path="/aigc_cfs_4/xibin/code/diffusers_triplane_models/img2img_albedo_6views_100k" \
