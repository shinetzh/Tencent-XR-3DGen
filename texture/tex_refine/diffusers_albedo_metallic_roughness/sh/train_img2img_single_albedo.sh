...
ASCEND_RT_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 \
accelerate launch --num_processes 8 --main_process_port 36658 \
    examples/modality_transfer/train_img2img_delight_single_albedo.py \
    --output_dir="/aigc_cfs_4/xibin/code/diffusers_triplane_models/delight_models_albedo" \
    --pretrained_model_name_or_path="/aigc_cfs_4/xibin/code/diffusers_triplane_models/delight_models_albedo" \
    ...
    --train_batch_size=6 --gradient_accumulation_steps=6 --gradient_checkpointing \
