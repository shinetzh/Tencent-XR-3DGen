...
class DatasetModTransfer_albedo(Dataset):
    def __init__(self,
        configs,
        data_type = "train",
        bg_color="white",
    ...
    def __getitem__(self, index):
        ...
        for condi in cond_idx_list_use:
            ...
            albedo_cond_path = os.path.join(image_dir, "emission/color", f"cam-{str(image_cond_sub_idx).zfill(4)}.png")
            ...
            albedo = to_rgb_image(albedo, 127)
...
if __name__ == "__main__":
    ...
    configs = {
                ...
                "data_config":{
                    "dataset_name" : "DatasetModTransfer_albedo",
                    ...
                    "dataset_json" : "/aigc_cfs_2/neoshang/data/data_list/20241021/part1_16_avatar_image_same_azimuth_remake_h20.json",
                    "image_size": 512,
                    "group_idx_list": [0, 1],
                    "cond_idx_list": [0,1,2,3,4,5],
                    "images_num_per_group": 26,
                    "load_from_cache_last": False
                }
            }

    train_dataset = DatasetModTransfer_albedo(configs, data_type="train", load_from_cache_last=False)
