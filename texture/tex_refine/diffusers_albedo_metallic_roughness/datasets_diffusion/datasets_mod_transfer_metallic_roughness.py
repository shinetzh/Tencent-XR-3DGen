...
class DatasetModTransfer_metallic_roughness(Dataset):
    def __init__(self,
        configs,
        data_type = "train",
        bg_color="white",
    ...
    def __getitem__(self, index):
        ...
        for condi in cond_idx_list_use:
            ...
            # metallic_cond_path = os.path.join(image_dir, "metallic/color", f"cam-{str(image_cond_sub_idx).zfill(4)}.png")
            roughness_cond_path = os.path.join(image_dir, "roughness/color", f"cam-{str(image_cond_sub_idx).zfill(4)}.png")
...
if __name__ == "__main__":
    ...
    train_dataset = DatasetModTransfer_metallic_roughness(configs, data_type="train", load_from_cache_last=False)
