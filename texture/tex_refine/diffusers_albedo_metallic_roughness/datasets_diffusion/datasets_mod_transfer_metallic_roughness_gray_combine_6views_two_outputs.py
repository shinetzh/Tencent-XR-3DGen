...
class DatasetModTransfer_metallic_roughness_two_outputs(Dataset):
    def __init__(self,
        configs,
        data_type = "train",
        bg_color="white",
...
if __name__ == "__main__":
    ...
    train_dataset = DatasetModTransfer_metallic_roughness_two_outputs(configs, data_type="train", load_from_cache_last=False)
