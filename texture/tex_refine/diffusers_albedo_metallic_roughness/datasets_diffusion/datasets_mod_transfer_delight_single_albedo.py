...
class DatasetModTransfer_single_albedo(Dataset):
    def __init__(self,
        configs,
        data_type = "train",
        bg_color="white",
    ...
    def __getitem__(self, index):
        ...
        if True:
            ...
            gt_cond_path = os.path.join(gt_dir, "emission/color", f"cam-{str(gt_cond_sub_idx).zfill(4)}.png")
...
if __name__ == "__main__":
    ...
    configs = {
                ...
                "data_config":{
                    "dataset_name" : "DatasetModTransfer_single_albedo",
                    ...
                    "cond_gt_idx_list": [0,1,2,3,4,8],
                    "images_num_per_group": 6,
                    "load_from_cache_last": False
                }
            }

    train_dataset = DatasetModTransfer_single_albedo(configs, data_type="train", load_from_cache_last=False)
