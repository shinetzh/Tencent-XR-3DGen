...
class DatasetModTransfer_albedo_6views_512(Dataset):
    def __init__(self,
        configs,
        data_type = "train",
        bg_color="white",
...
if __name__ == "__main__":
    ...
    train_dataset = DatasetModTransfer_albedo_6views_512(configs, data_type="train", load_from_cache_last=False)
