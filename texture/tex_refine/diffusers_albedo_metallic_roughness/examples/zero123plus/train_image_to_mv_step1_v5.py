        ...
        for step, batch in enumerate(train_dataloader):
            with accelerator.accumulate(unet):
                ...
                if random.random() < prob_train_cond:
                    ...
                    latents_out_cond = latents_out_cond * vae.config.scaling_factor
                    latents_out_grid = scale_latents(latents_out_cond)
                ...
                latents_cond_train = latents_cond_vae * vae.config.scaling_factor
                latents_cond_train = scale_latents(latents_cond_train)
