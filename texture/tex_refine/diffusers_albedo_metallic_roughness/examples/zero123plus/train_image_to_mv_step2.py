...
def parse_args():
    ...
    parser.add_argument(
        "--pretrain_unet_ckpt_dir",
        type=str,
        default=None,
        help=("pretrain unet dir for unet and unet_ema, did not load optimizer"),
    )
...
def main():
    ...
    if args.pretrain_unet_ckpt_dir is not None:
        print(f"load unet from {args.pretrain_unet_ckpt_dir}")
        unet_ckpt_path = os.path.join(args.pretrain_unet_ckpt_dir, "unet", "diffusion_pytorch_model.safetensors")
        load_model(_unet_, unet_ckpt_path)
    ...
    if args.use_ema:
        ...
        if args.pretrain_unet_ckpt_dir is not None:
            print(f"ema_unet load unet from {args.pretrain_unet_ckpt_dir}")
            unet_ema_ckpt_path = os.path.join(args.pretrain_unet_ckpt_dir, "unet_ema", "diffusion_pytorch_model.safetensors")
            load_model(ema_unet, unet_ema_ckpt_path)
