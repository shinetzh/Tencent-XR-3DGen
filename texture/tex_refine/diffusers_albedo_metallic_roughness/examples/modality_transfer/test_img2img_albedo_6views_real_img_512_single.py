...
img2img_pipeline = Img2ImgPipeline.from_pretrained(
                    ...
                    "/aigc_cfs_4/xibin/code/diffusers_triplane_models/img2img_albedo_6views_100k",
...
# Run the pipeline
root_save_dir = "/aigc_cfs_4/xibin/code/diffusers_triplane_models/6views_albedo_real_img_res_512_100k"
...
for i in range(10):
    ...
    folder = "0fb4c98662f61aecae70d31df7ef3b3e"
    folder_each = os.path.join(test_path, folder)
    ...
    mv_imgs = img2img_pipeline(images, num_inference_steps=30, guidance_scale=s, width=img_size*2, height=img_size*3).images[0]
    mv_imgs.save(os.path.join("./albedo_guidance", folder + "_" + str(s) + ".png"))
    # image_input.save(os.path.join("./albedo_res", folder + "_input.png"))