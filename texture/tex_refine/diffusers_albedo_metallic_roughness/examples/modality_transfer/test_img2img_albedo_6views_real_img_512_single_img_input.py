...
img_path = "./final_images_d2rgb.png"
...
if True:
    ...
    mv_imgs = img2img_pipeline(images, num_inference_steps=30, guidance_scale=1.0, width=img_size*2, height=img_size*3).images[0]
    mv_imgs.save(os.path.join("albedo_res.png"))
