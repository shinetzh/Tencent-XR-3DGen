...
# sys.path.append("/aigc_cfs_4/xibin/code/diffusers_triplane")
# sys.path.append("/aigc_cfs_4/xibin/code/diffusers_triplane_metallic_roughness")
# sys.path.append("/aigc_cfs_4/xibin/code/diffusers_albedo_metallic_roughness")
