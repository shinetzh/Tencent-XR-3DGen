...
from src.diffusers.pipelines.img2img.pipeline_img2img_albedo_metallic_roughness_bumpmap import Img2ImgPipeline
...
img2img_pipeline = Img2ImgPipeline.from_pretrained(
                    ...
                    "/aigc_cfs_4/xibin/code/diffusers_triplane_models/img2img_albedo_metallic_roughness_bumpmap_6views_v_prediction",
...
# Run the pipeline
root_save_dir = "/aigc_cfs_4/xibin/code/diffusers_triplane_models/6views_albedo_metallic_roughness_v_prediction_185000"
...
for folder in folder_list:
    ...
    channels = mv_imgs[1].images[0].split()

    for i, channel in enumerate(channels):
        channel_path = os.path.join(root_save_dir, folder + f'channel_' + f'_{i}.jpg')  # 保存路径及文件名格式
