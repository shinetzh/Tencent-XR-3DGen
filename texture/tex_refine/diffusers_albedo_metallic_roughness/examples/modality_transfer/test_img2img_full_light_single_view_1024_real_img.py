...
# Run the pipeline
root_save_dir = "/aigc_cfs_4/xibin/code/diffusers_triplane_models/test_images_delight_res_1024_real_img_" + str(seed) 
...
for name in img_name_list:
    ...
    if True:
        ...
        if True:
            ...
            # image = image.unsqueeze(0)
            print(image.shape)
            mv_imgs = img2img_pipeline(image, num_inference_steps=30, guidance_scale=0.5, width=1024, height=1024).images[0]
